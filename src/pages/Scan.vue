<template>
  <q-page class="col">
    <div class="q-pa-md items-start q-gutter-sm">
      ...
      <q-btn color="primary" label="Copy" v-clipboard:copy="cipherText" v-clipboard:success="onCopy" v-clipboard:error="onError" />
      </q-card-actions>
      <q-separator />
      <q-card-section>
...
export default {
  ...
  methods: {
    ...
    encrpt() {
      this.cipherText = this.CryptoJS.AES.encrypt(this.result, this.key).toString()
    },
    onCopy: function (e) {
